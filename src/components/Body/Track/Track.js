const Track = () => {
    ...
    const tracks = ['1','2','3'].map((el, id)=>{
        console.log(id)
        return (
            <div key={id} className="space-y-3  border-2 border-white lg:space-y-1 w-60 sm:w-5/12 md:w-4/12 lg:w-3/12 font-cabin rounded-xl text-center p-5 lg:p-5 md:p-3 text-xl bg-gray-300 ">
