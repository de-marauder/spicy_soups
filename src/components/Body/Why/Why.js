    ...
    return (
        <div>
            <div className="mt-20">
                ...
                <strong className="font-neon text-orange-600 text-4xl sm:text-5xl">Why people choose us</strong>
            </div>
            <div>
            ...
            <div className="mt-10 mx-auto md:w-10/12 lg:w-9/12 flex flex-wrap lg:gap-x-8 gap-10 justify-center items-center">
                {/* {tracks} */}
                <div className="space-y-3 border-2 border-white lg:space-y-1 w-60 sm:w-5/12 md:w-4/12 lg:w-3/12 font-cabin rounded-xl text-center p-5 lg:p-5 md:p-3 text-xl">
                    <img className='mx-auto w-20 h-20' src={Img1} alt='' />
                    <h2 className="text-orange-400 text-xl">Express delivery</h2>
                    <hr className="border-orange-700" />
                    <p className="text-white text-sm">Enter your address or choose your current location using app.</p>
                </div>

                <div className="space-y-3 border-2 border-white lg:space-y-1 w-60 sm:w-5/12 md:w-4/12 lg:w-3/12 font-cabin rounded-xl text-center p-5 lg:p-5 md:p-3 text-xl">
                    <img className='mx-auto w-20 h-20' src={Img2} alt='' />
                ...
                <div className="space-y-3 border-2 border-white lg:space-y-1 w-60 sm:w-5/12 md:w-4/12 lg:w-3/12 font-cabin rounded-xl text-center p-5 lg:p-5 md:p-3 text-xl">
                    <img className='mx-auto w-20 h-20' src={Img3} alt='' />
