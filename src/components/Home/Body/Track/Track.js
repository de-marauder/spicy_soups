const Track = () => {
    ...
    return (
        <div className="-mt-32 w-3/4 md:w-10/12 lg:w-9/12 flex flex-wrap lg:gap-x-8 justify-center items-center">
            <div className="mb-10 sm:mr-10 lg:m-0 space-y-3 lg:space-y-1 w-60 sm:w-5/12 md:w-4/12 lg:w-3/12 font-cabin rounded-xl text-center p-5 lg:p-5 md:p-3 text-xl bg-gray-300 ">
