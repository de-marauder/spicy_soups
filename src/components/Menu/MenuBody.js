    ...
    const filter = (
        <div className="w-full space-y-3 mb-5 px-4 sm:px-2 h-fit sm:h-full sm:w-4/12">
            ...
            <div className={`flex flex-wrap transition-all px-2 overflow-hidden justify-around ${tagActive ? 'h-fit' : 'h-0'} `}>
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['hello'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['eba'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="eba" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['bitterleaf'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="bitterleaf" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['afang'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="afang" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['egusi'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="egusi" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['okra'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="okra" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['meat'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="meat" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['fish'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="fish" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['chicken'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="chicken" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['towel'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="towel" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['yam'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="yam" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['plantain'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="plantain" />
                <input onChange={(event) => { if (event.target.checked) { props.search(event) } }} type='checkbox' name="mealTag" className="flex justify-center relative ml-5 mr-8 w-8 mb-8 checked:before:bg-green-600 before:absolute before:content-['rice'] before:w-fit before:before:p-1 before:px-4 before:mr-3 before:mb-3 before:bg-stone-600 before:hover:bg-green-300 before:rounded-3xl before:text-white" value="rice" />
            </div>
